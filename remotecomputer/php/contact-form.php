...
if(isset($_POST['email'])) {
	...
	// PHP Mailer Library - Docs: https://github.com/PHPMailer/PHPMailer
		...
		$mail->Host = 'webmail.traveler.cm';				  // Specify main and backup server
		$mail->SMTPAuth = true;                             // Enable SMTP authentication
		$mail->Username = 'stuenofotso@traveler.cm';             		  // SMTP username
		$mail->Password = 'Tra_Ste_2015';                         // SMTP password
